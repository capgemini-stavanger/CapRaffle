...
ALTER TABLE Winner Drop CONSTRAINT FK_Winner_Event;
ALTER TABLE Winner Add constraint FK_Winner_Event foreign key (EventId) references Event(EventId) ON DELETE CASCADE;